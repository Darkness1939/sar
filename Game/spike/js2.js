...
{ 
    ...
    if(health <= 0)
 {
    ...
    function fight(){
        ...
        var timer1 = setInterval("if(health > 0) {health = health - 2; document.getElementById('G').innerText = `${health}`; endh = false;} else{endh = true;  document.getElementById('text').style.display= 'flex'; document.getElementById('text').innerHTML = `You dead! <button id= 'dres' onclick= 'woo();'>Reset</button>`; health = 0; document.getElementById('G').innerText = 0;}", 750);
    ...
    function woo(){
        document.location = 'D:/game/Game/start/index.html';
    }